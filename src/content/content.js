...
const Content = (function () {
  ...
  return { heroes, items, combos, waves, modifiers, curses, ranks, mutations, rankCurses, formations, bonds, towerDefense, damageTypeNames: DAMAGE_TYPE_NAMES, actNames: ACT_NAMES, attrNames, attrShort };
})();
