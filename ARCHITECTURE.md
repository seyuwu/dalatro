...
- **Забеги.** `POST /api/runs` — компоненты (волны, ранг, казармы, лучший
  ...
  Хвост: 100 забегов на игрока, 20 000 всего. Без аккаунта забег уходит
  как гостевой (токен браузера, «Гость #XXXX», ≤10/час с IP); при
  регистрации/входе с тем же токеном гостевые забеги переезжают в аккаунт,
  статистика пересчитывается по ним.
