...
Пять волн: T1/T2/T3 + мини-босс Techies + Roshan. Модификаторы-правила в
...
12 героев в колоде (7 с абилками) + 28 в таверне (24 со способностями) · 19 предметов ·
...
- **22 героя ростера** получили способности из декларативных
...
51 тест: покер, детекционные хуки, математика, позиции, Refresher,
